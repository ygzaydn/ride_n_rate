...
exports.new_comment = exports.deleteComment = exports.editComment = exports.createComment = exports.getComments = exports.companyID = exports.cityFilterBuilder = exports.companySearchDetailed = exports.getTime = exports.commentInput = exports.commentList = exports.submit = exports.companyCommentArr = exports.companyComment = undefined;
...
var getComments = async function getComments(page) {
  ...
  try {
    ...
    var resultData = result.data;
    console.log(resultData);
    var section = document.querySelector(".comment-list");
...
var createComment = async function createComment(body) {
  ...
  var config = {
    ...
    url: _register.url + "/api/companies/comment/create",
    method: "post",
    data: {
      companyUUID: uuid,
      commentBody: body
...
var editComment = async function editComment(body, uuid) {
  var token = localStorage.getItem("token");
  var config = {
    headers: {
      Authorization: "Bearer " + token
    },
    url: _register.url + "/api/companies/comment/update",
    method: "post",
    data: {
      commentBody: body,
      commentUUID: uuid
...
var deleteComment = async function deleteComment(uuid) {
  var token = localStorage.getItem("token");
  var config = {
    headers: {
      Authorization: "Bearer " + token
    },
    url: _register.url + "/api/companies/comment/delete",
    method: "post",
    data: {
      commentUUID: uuid
    }
...
var _companyCommentModel = require("../models/companyCommentModel");
...
window.editComment = async function (e) {
  ...
  var uuid = parentElement.children[3].innerHTML;
  ...
  if (text) {
    _sweetalert2.default.fire(text);
...
window.deleteComment = async function (e) {
  ...
  _sweetalert2.default.fire({
    ...
    if (result.value) {
      _sweetalert2.default.fire("Kaldırıldı", "Yorumun başarılı bir şekilde kaldırıldı", "success");
