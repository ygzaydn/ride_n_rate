...
document.getElementById("post_comment").addEventListener("click", function (event) {
  ...
  var newComment = {
    name: _companyCommentModel.companyCommentArr[0],
    email: _companyCommentModel.companyCommentArr[1],
    message: _companyCommentModel.companyCommentArr[2],
    avatar: "/src/images/comment_vcard.jpg"

  };

  var comment = new _companyCommentModel.new_comment(newComment.name.value, newComment.email.value, newComment.message.value, newComment.avatar);
  ...
  if (comment.avatar !== "" && comment.email !== "" && comment.message !== "" && comment.name !== "") {
    ...
    localStorage.setItem('commentListing', _companyCommentModel.commentList.innerHTML);
...
},{"../models/companyCommentModel":28,"../register":29}]},{},[30]);
