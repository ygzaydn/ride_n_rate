...
var resetPassword = async function resetPassword(password, uuid) {
    var config = {
        url: _register.url + '/api/auth/password-reset-callback',
        method: 'post',
        data: {
            uuid: uuid,
            password: password
    ...
    try {
        var result = (0, _axios2.default)(config);
        console.log(result);
        _sweetalert2.default.fire('Şifre değiştirme başarılı', 'Yeni şifreni kullanarak kolaylıkla giriş yapabilirsin.', 'success');
    } catch (err) {
        _sweetalert2.default.fire('Şifre değiştirme sırasında bir hata oluştu', 'error');
        console.log(err);
    }
};
...
var _forgotPaswordModel = require('../models/forgotPaswordModel');
...
document.getElementById('SignUp').addEventListener('click', function () {
    ...
    var password = document.getElementById('password_box_sign_up').value;
    var rePassword = document.getElementById('repassword_box_sign_up').value;

    if (password === rePassword && password) {
        console.log(password);
        console.log(uuid);
        (0, _forgotPaswordModel.resetPassword)(password, uuid);
    } else {
        _sweetalert2.default.fire('Şifre değiştirme sırasında bir hata oluştu', 'Lütfen bilgileri doğru girdiğinden emin ol.', 'error');
    }
});

},{"../models/forgotPaswordModel":29,"sweetalert2":28}]},{},[31]);
