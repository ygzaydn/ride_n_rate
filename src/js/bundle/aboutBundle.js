...
exports.logOut = exports.userInfo = exports.countNumber = undefined;
...
async function countNumber() {
    var config = {
        method: 'get',
        url: _register.url + '/api/stats/review/count',
        headers: { 'Authorization': 'Token ' + localStorage.getItem('token') }
    };
    try {
        var res = await axios(config);
        var countNum = res.data.count;
...
async function userInfo() {
    ...
    try {
        ...
        var date = res.data.data.createdAt;
        date = date.split("T");
...
async function logOut() {
    var config = {
        method: 'get',
        url: _register.url + '/api/auth/logout',
        headers: { 'Authorization': 'Token ' + localStorage.getItem('token') }
        /*         data: {
